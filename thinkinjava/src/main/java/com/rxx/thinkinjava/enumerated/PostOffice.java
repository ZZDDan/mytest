...
import com.rxx.thinkinjava.concurrency.Enums;
...
public class PostOffice {
   ...
   * Readability: YES1, Address Address: OK1, Return address: OK5 Using general
   * delivery for Mail 2
   *****
   ...
   * Readability: YES3, Address Address: INCORRECT, Return address: MISSING Mail
   * 8 is a dead letter
   *****
